...
class PlanificarAsignaturaIndex extends Component
{
    ...
    public function render()
    {
        ...
        $paralelos = SiadiParalelo::leftJoin('siadi_planificar_asignaturas', 'siadi_planificar_asignaturas.id_paralelo', '=', 'siadi_paralelos.id_paralelo')
            ...
            ->where('estado_paralelo', '=', 'ACTIVO')
            ->where('siadi_convocatorias.id_siadi_convocatoria', '=', $this->convocatoria_estudiante)
            ->where('siadi_planificar_asignaturas.id_siadi_asignatura', '=', $this->asignatura)
            # ->whereIsNull('siadi_planificar_asignaturas.id_paralelo')
            ->get();
