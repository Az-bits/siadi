...
class Certificados extends Model
{
    ...
    */
    ...
    private function addColumnModalidadCertificado($query){
        $query->addSelect(
            DB::raw("CASE 
                    ...
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante=1 AND siadi_costos.tipo_costo='TGN' THEN 'CURSO REGULAR'
            ...
            DB::raw("CASE
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(3, 6, 7, 8) THEN siadi_convocartoria_estudiantes.nombre_convocatoria_estudiante -- homologacion, convalidacion, ambos
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(2, 4, 5) THEN siadi_convocartoria_estudiantes.nombre_convocatoria_estudiante -- prueba de examen, actualizacion, migracion
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante=1 THEN CONCAT(siadi_convocartoria_estudiantes.nombre_convocatoria_estudiante, ' (', siadi_costos.tipo_costo, ')')
    ...
    private function addColumnCargaHorariaCertificado($query){
        $query->addSelect(
            DB::raw("CONCAT ( CASE 
                            WHEN siadi_nivel_idiomas.nombre_nivel_idioma LIKE '1.1' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante=1 AND siadi_costos.tipo_costo='TGN' THEN 0 -- 1 ,CURSO REGULAR COSTO='TGN'
                            WHEN siadi_nivel_idiomas.nombre_nivel_idioma LIKE '%.2' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante=1 AND siadi_costos.tipo_costo='TGN' THEN
                            (
    ...
    private function addColumnsFormatoCertificado($query){
        $query->addSelect(
            DB::raw("CASE 
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN (3, 7) THEN 'formato6' -- 3=Convalidacion departamento de idiomas Y CARRERA
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 8 THEN 'formato1' -- #is1 8=Homologacion linguistica e idiomas
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(1, 2, 6) THEN 'formato7' -- #is1 1=Curso Regular, 2=Prueba de examen de suficiencia, 6=Homologacion deppartamento de idiomas
                    WHEN siadi_gestions.nombre_gestion <= '2019' THEN 'formato7' -- certificacion antigua

                    -- nuevos
                    WHEN (siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='TGN') OR siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(3, 7) THEN 'formato5' -- 1=curso regular (tgn) or convalidacion ambos
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 8 THEN 'formato3' -- homologacion carrera
                    ELSE 'formato4' -- demás certificados nuevos
                END AS formato")
            /* DB::raw("CASE 
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN (3, 7) THEN 'formato2' -- 3=Convalidacion departamento de idiomas Y CARRERA
                    ...
                    WHEN siadi_gestions.nombre_gestion <= '2019' THEN 'formato4' -- certificacion antigua

                    -- nuevos
                    WHEN (siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='TGN') OR siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(3, 7) THEN 'formato3' -- 1=curso regular (tgn) or convalidacion ambos
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 8 THEN 'formato1' -- homologacion carrera
                    ELSE 'formato3' -- demás certificados nuevos
                END AS formato"),
            DB::raw("CASE
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN (3, 7) THEN 'o_certificado_2_6.jpg' -- 3=Convalidacion departamento de idiomas
                    ...
                    WHEN siadi_gestions.nombre_gestion <= '2019' AND siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(1, 2, 6) THEN 'o_certificado_1_7.jpg' -- 1=Curso Regular, 2=Prueba de examen de suficiencia, 6=Homologacion deppartamento de idiomas
                    WHEN siadi_gestions.nombre_gestion <= '2019' THEN 'o_certificado_1_7.jpg' -- certificacion antigua
                    
                    -- nuevos
                    WHEN (siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='TGN') OR siadi_convocartoria_estudiantes.id_convocartoria_estudiante IN(3, 7) THEN 'n_certificado_3_5.jpg' -- 1=curso regular (tgn) or convalidacion ambos
                    WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 8 THEN 'n_certificado_1_3.jpg' -- homologacion carrera
                    
                    ELSE 'n_certificado_3_4.jpg' -- demás certificados nuevos
                END AS plantilla") */
        );
    }
    ...
    private function addColumnSugeridoInicialNotas($query){
        $query->addSelect(
            DB::raw("CASE 
                        ...
                        WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='TGN' THEN 'T' -- CURSO REGULAR (TGN)
                        WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='AUTOFINANCIADO' THEN 'A' -- CURSO REGULAR (AUTOFINANCIADO)
                        WHEN siadi_convocartoria_estudiantes.id_convocartoria_estudiante = 1 AND siadi_costos.tipo_costo ='CONVENIO' THEN 'N' -- CURSO REGULAR (CONVENIO) -- consultar
                        ELSE 'Z'
                    END AS inicial")
        );
    }
