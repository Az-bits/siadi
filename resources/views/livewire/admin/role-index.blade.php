                                    ...
                                    @foreach ($chunk as $permission)
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="{{ $permission->id }}"
                                                    data-on-label="Yes" data-off-label="No"></label>
                                                <a class="badge rounded-pill badge-soft-primary font-size-12" href="" target="_blank">Ayuda <i class="bx bx-help-circle"></i></a>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">ADMINISTRACION DE ROLES dfdsg</h4>
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="btn btn-outline-primary waves-effect waves-light col-md-6 "
                                data-bs-toggle="modal" data-bs-target="#agregaRol"> <i
                                    class="bx bxs-plus-circle">AGREGAR nada</i></button>
