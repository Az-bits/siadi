<div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="float-end">
                        ...
                        <input type="checkbox" id="estilo_asignaturas" switch="bool"
                            {{ $estilo_asignaturas == true ? 'checked' : '' }} wire:model="estilo_asignaturas">
                        <label class="form-label" for="estilo_asignaturas" data-on-label="Si"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-outline-primary waves-effect waves-light col-md-6 "
                                wire:click="agregar_asignatura"> {{-- data-bs-toggle="modal" data-bs-target="#agregarplanificar_asignatura" --}}
                        ...
                        <div class="col-12 row">
                            ...
                            @if ($estado_convocatoria_sede)
                                <div class="col-12 col-md-4">
                                    ...
                                    <select name="f_convocatoria_sede" id="f_convocatoria_sede" class="form-select"
                                        wire:model="f_convocatoria_sede">
                                        <option value="">Elegir...</option>
                                    ...
                                    <select name="f_nivel" id="f_nivel" class="form-select" wire:model="f_nivel">
                                        ...
                                        @foreach ($niveles as $nivel)
                                            <option value="{{ $nivel->id_nivel_idioma }}">
                                                ...
                                                {{ $nivel->descripcion_nivel_idioma }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            @endif
                    ...
                    @if ($planificar_asignaturas->count() > 0)
                        @if ($estado_f_idioma)
                            <h3 class="text-center"> <span
                                    title="Nombre Convocatoria">{{ $planificar_asignaturas[0]->siadi_convocatoria->nombre_convocatoria }}</span>
                                .:: <span
                                    title="Sede UPEA">{{ $planificar_asignaturas[0]->siadi_convocatoria->siadi_sede->sede_upea->nombre }}</span>
                            </h3>
                            <div class="row">
                                <div class="col-md-4">
                                    <button class="btn btn-outline-info waves-effect waves-light col-md-6 "
                                        wire:click="subir_nota_limite_convocatoria({{ $planificar_asignaturas[0]->siadi_convocatoria->id_siadi_convocatoria }})">
                                        {{-- data-bs-toggle="modal" data-bs-target="#agregarplanificar_asignatura" --}}
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($planificar_asignaturas as $planificar_asignatura)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $planificar_asignatura->siadi_convocatoria->siadi_sede->direccion }}
                                                    <br>
                                                ...
                                                <td>
                                                    <span title="Fecha inicio de clases"
                                                        class="text-primary">{{ $planificar_asignatura->fecha_inicio }}</span>
                                                    <br>
                                                    <span
                                                        title="Fecha fin de clases">{{ $planificar_asignatura->fecha_fin }}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button type="button" title="Editar"
                                                        ...
                                                        wire:click="editar_planificar_asignatura({{ $planificar_asignatura->id_planificar_asignatura }})">
                                                        {{--  data-bs-toggle="modal" data-bs-target="#editarplanificar_asignatura" --}}
                        ...
                        @else
                            <div class="row g-3 col-md-12">
                                ...
                                @foreach ($planificar_asignaturas as $planificar_asignatura)
                                    ...
                                    @endphp
                                    <div class="col-md-6">
                                        <div class="card radius-10 border-start border-1 border-5 border-{{ $color }} @if ($id_planificar_asignatura == $planificar_asignatura->id_planificar_asignatura) bg-soft-info @endif"
                                            style="border-width: 1px 1px 1px 7px;">
                                            <div class="card-header">
                                                <div class="float-start bg-{{ $color }} text-white m-0 p-1">
                                                    <b>{{ $planificar_asignatura->id_planificar_asignatura }}</b>
                                                </div>
                                                <h4 class="my-0 text-{{ $color }} text-center"><i
                                                        class="mdi mdi-check-all me-3"></i>
                                                    {{ $planificar_asignatura->siadi_asignatura->idioma->nombre_idioma }}
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center row g-3">
                                                    <ul class="list-group col-md-7 border-2">
                                                        ...
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center text-secondary">
                                                            <div>
                                                                <i class="fs-6 bx bxs-map-alt"></i> <b>DIRECCIÓN</b>
                                                                <br>
                                                        ...
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center text-secondary">
                                                            <span><i class="fs-6 bx bxs-time-five"></i> <b>CARGA
                                                                    HORARIA</b> </span>
                                                            <span>{{ $planificar_asignatura->carga_horaria_planificar_asignartura }}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center text-secondary">
                                                            <span><b>CUPO MÍNIMO</b>
                                                                {{ $planificar_asignatura->cupo_minimo_paralelo }}</span>
                                                            <span><b>CUPO MÁXIMO</b>
                                                                {{ $planificar_asignatura->cupo_maximo_paralelo }}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center text-secondary">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <h4
                                                                    class="my-1 mt-0 text-{{ $color }} {{ strlen($planificar_asignatura->siadi_paralelo->nombre_paralelo) >= 8 ? 'fs-6' : '' }}">
                                                                    {{ $planificar_asignatura->siadi_paralelo->nombre_paralelo }}
                                                                </h4>
                                                            </div>
                                                            <div class="col-md-6 border-start border-0 border-2">
                                                                <p class="mb-0 text-secondary">Gestión</p>
                                                                <h4 class="my-1 mt-0 text-{{ $color }}">
                                                                    {{ $planificar_asignatura->siadi_convocatoria->periodo }}-{{ $planificar_asignatura->siadi_convocatoria->gestion->nombre_gestion }}
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        <hr class="border-1 mt-0">
                                                        <p class="mb-0 text-secondary">Turno:
                                                            {{ $planificar_asignatura->hora_clases_inicio }}-{{ $planificar_asignatura->hora_clases_fin }}
                                                        </p>
                                                        <h4 class="my-1 text-{{ $color }}"><i
                                                                class="bx {{ $estilo_turno[$planificar_asignatura->turno_paralelo]['icono'] }} {{ $estilo_turno[$planificar_asignatura->turno_paralelo]['color'] }}"></i>
                                                            {{ $planificar_asignatura->turno_paralelo }}</h4>
                                                        <hr class="border-1 mt-0">
                                                        <p class="mb-0 text-secondary">Costo
                                                            ({{ $planificar_asignatura->siadi_convocatoria->convocatoria_costo->tipo_costo }})
                                                        </p>
                                                        <h4 class="my-1 text-{{ $color }}"><i
                                                                class="bx bx-money"></i>
                                                            {{ $planificar_asignatura->siadi_convocatoria->monto_convocatoria }}
                                                        ...
                                                        <h4 class="my-1 text-{{ $color }}"><i
                                                                class="bx bxs-user-check "></i> {{ $inscritos }}
                                                        </h4>
                                                        <hr class="border-1 mt-0">
                                                            ...
                                                            @if ($planificar_asignatura->siadi_convocatoria->modalidad->id_convocartoria_estudiante == 2)
                                                                @if ($estado_rhcc)
                                                                    <p class="mt-0 pt-0 text-secondary "
                                                                        title="resolución RHCC">
                                                                        <small>{{ $planificar_asignatura->resolucion_rhcc }}</small>
                                                                    </p>
                                                                @else
                                                                    <p class="mt-0 pt-0 text-danger "
                                                                        title="resolución RHCC"><small>Sin resolución
                                                                            RHCC</small></p>
                                                                @endif
                                                            @endif
                                                        @else
                                                            ...
                                                            <h6 class="my-1 text-{{ $color }}">
                                                                <!-- <i class="bx bxs-user-detail"></i> -->
                                                                @if ($estado_nom)
                                                                    <span
                                                                        class="text-secondary">{{ $planificar_asignatura->siadi_nombramiento->grado_nombramiento }}</span>
                                                                @endif
                                                                {{ $planificar_asignatura->siadi_persona_asignada_docente->nombre . ' ' . $planificar_asignatura->siadi_persona_asignada_docente->paterno . ' ' . $planificar_asignatura->siadi_persona_asignada_docente->materno }}
                                                            </h6>
                                                            @if ($planificar_asignatura->siadi_convocatoria->modalidad->id_convocartoria_estudiante == 2)
                                                                @if ($estado_rhcc)
                                                                    <p class="mt-0 pt-0 text-secondary "
                                                            ...
                                                            @else
                                                                @if ($estado_nom)
                                                                    <p class="mt-0 pt-0 text-secondary "
                                                                        ...
                                                                        <small>{{ $planificar_asignatura->siadi_nombramiento->item_nombramiento }}</small>
                                                                    </p>
                                                                @else
                                                                    <p class="mt-0 pt-0 text-danger "
                                                                        title="nombramiento docente"><small>Sin
                                                                            Nombramineto asignado</small></p>
                                                                @endif
                                                            @endif
                                                        @endif
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <span
                                                        class="text-white bg-success rounded-2 small">{{ $inscritos }}/{{ $planificar_asignatura->cupo_maximo_paralelo }}</span>
                                                    estudiantes inscritos
                                                    <div class="progress mb-4 bg-soft-secondary"
                                                        style="height: 15px;">
                                                        <div class="progress-bar bg-danger" role="progressbar"
                                                            style="width: <?= $porcentaje_plan_asign ?>%"
                                                            aria-valuenow="{{ $porcentaje_plan_asign }}"
                                                            aria-valuemin="0" aria-valuemax="100">
                                                            {{ $porcentaje_plan_asign }}%</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 d-flex justify-content-evenly">
                                                    ...
                                                    <a class="btn btn-outline-info waves-effect waves-light @if ($estado_cert_provisional) d-flex align-items-center @endif"
                                                        ...
                                                        <i
                                                            class="@if ($estado_cert_provisional) d-block @endif bx bx-list-ul fs-6"></i>
                                                        LISTAR
                                                    </a>
                                                    @if ($inscritos > 0)
                                                        @can('planificar_asignatura.acta_calificaciones')
                                                            <a class="btn btn-outline-danger waves-effect waves-light"
                                                                ...
                                                                href="{{ route('reporte_planificar_asignatura', ['id_planificar_asignatura' => base64_encode(str_pad($planificar_asignatura->id_planificar_asignatura, 15, '0', STR_PAD_LEFT))]) }}">
                                                                <i
                                                                    class="@if ($estado_cert_provisional) d-block @endif bx bxs-file-pdf fs-4"></i>
                                                                ACTA
                                                            </a>
                                                        @endcan
                                                        @can('reporte_planificar_asignatura_excel')
                                                            <a class="btn btn-outline-success waves-effect waves-light"
                                                                ...
                                                                <i
                                                                    class="@if ($estado_cert_provisional) d-block @endif fas fa-file-excel fs-5"></i>
                                                                EXCEL
                                                            </a>
                                                        @endcan
                                                        {{-- <a class="btn btn-outline-success waves-effect waves-light"
                                                            ...
                                                            href="{{ route('reporte_planificar_asignatura_csv', ['id_planificar_asignatura' => base64_encode(str_pad($planificar_asignatura->id_planificar_asignatura, 15, '0', STR_PAD_LEFT))]) }}">
                                                            <i
                                                                class="@if ($estado_cert_provisional) d-block @endif fas fa-file-csv fs-5"></i>
                                                            CSV
                                                        </a> --}}
                                                        @if ($estado_certificado)
                                                            <a class="btn btn-outline-success waves-effect waves-light"
                                                        ...
                                                        @if ($estado_cert_provisional)
                                                            <a class="btn btn-outline-success waves-effect waves-light"
                                                                ...
                                                                href="{{ route('certificado_provisional_plan_asignatura', ['id_planificar_asgnatura' => $planificar_asignatura->id_planificar_asignatura]) }}"><i
                                                                    class="bx bxs-file-pdf fs-4"></i> CERTIFICADOS <br>
                                                                PROVISIONALES
                                                            </a>
                                                        @endif
                                                    @endif
                                            ...
                                            @if (Auth::user()->roles[0]->name == 'Admin')
                                                <div class="card-footer d-flex justify-content-evenly">
                                                    ...
                                                    <button type="button" title="Editar"
                                                        ...
                                                        {{-- data-bs-target="#editarplanificar_asignatura" data-bs-toggle="modal" --}}
                                                        <i class="bx bx-pencil"></i>
                                                    </button>
                                                    ...
                                                    @php
                                                        ...
                                                        $limite = !is_null($planificar_asignatura->fecha_limite_subir_nota) && $planificar_asignatura->fecha_limite_subir_nota !== '' ? \Carbon\Carbon::parse($planificar_asignatura->fecha_limite_subir_nota . ' 23:59:59') : '';
                                                    @endphp
                                                    <button type="button"
                                                        class="btn btn-outline-{{ $fecha <= $limite && $limite !== '' && $planificar_asignatura->estado_docente == '1' ? 'success' : 'danger' }} waves-effect waves-light"
                                                    ...
                                                    <div class="btn-group dropup">
                                                        <button type="button"
                                                            class="btn btn-outline-warning waves-effect waves-light dropdown-toggle"
                                                        ...
                                                        <ul class="dropdown-menu p-2 border border-1 border-warning">
                                                            <li><button
                                                                    ...
                                                                    wire:click="mostrar_form_asignar_docente({{ $planificar_asignatura->id_planificar_asignatura }})">ASIGNACIÓN
                                                                    DOCENTE</button></li>
                                                            <li>
                                                            ...
                                                            <li><button
                                                                    class="btn btn-outline-primary waves-effect waves-light"
                                                                    wire:click="mostrar_form_libro_nota({{ $planificar_asignatura->id_planificar_asignatura }})">FOLIO,
                                                                    LIBRO DE ACTAS</button></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model="convocatoria_estudiante"
                                            class="form-select @error('convocatoria_estudiante') border-danger @enderror"
                                            id="convocatoria_estudiante">
                                            <option value="">Elegir...</option>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model="asignatura"
                                            class="form-select @error('asignatura') border-danger @enderror"
                                            id="asignatura">
                                            <option value="">Elegir...</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model="id_paralelo"
                                            class="form-select @error('id_paralelo') border-danger @enderror"
                                            id="id_paralelo" @if (
                                                $errors->has('convocatoria_estudiante') ||
                                                    $errors->has('asignatura') ||
                                                    $convocatoria_estudiante == '' ||
                                                    ($asignatura = '')) disabled @endif>
                                            <option value="">Elegir...</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select wire:model="turno_paralelo"
                                            class="form-select @error('turno_paralelo') border-danger @enderror"
                                            id="turno_paralelo">
                                            <option value="">Elegir...</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="time"
                                            class="form-control @error('hora_inicio') border-danger @enderror"
                                            wire:model="hora_inicio" id="hora_inicio"
                                            @if ($estado_horas == false) disabled @endif>
                                        @error('hora_inicio')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="time"
                                            class="form-control @error('hora_fin') border-danger @enderror"
                                            wire:model="hora_fin" id="hora_fin"
                                            @if ($estado_horas == false) disabled @endif>
                                        @error('hora_fin')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('cupo_minimo') border-danger @enderror"
                                            wire:model="cupo_minimo">
                                        @error('cupo_minimo')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('cupo_maximo') border-danger @enderror"
                                            wire:model="cupo_maximo">
                                        @error('cupo_maximo')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number"
                                            class="form-control @error('carga_horaria') border-danger @enderror"
                                            wire:model="carga_horaria" placeholder="Horas">
                                        @error('carga_horaria')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            class="form-control @error('fecha_inicio') border-danger @enderror"
                                            wire:model="fecha_inicio" id="fecha_inicio" pattern="\d{4}-\d{2}-\d{2}">
                                        @error('fecha_inicio')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date"
                                            class="form-control @error('fecha_fin') border-danger @enderror"
                                            wire:model="fecha_fin" id="fecha_fin" pattern="\d{4}-\d{2}-\d{2}">
                                        @error('fecha_fin')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
            ...
            <div wire:ignore.self data-bs-backdrop="static" id="editar_subir_nota_planificar_asignatura"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row g-3">
                                <div class="col-md-5">
                                    <div class="mb-3">
                                        <label class="form-label" for="fecha_limite_notas">FECHA LÍMITE PARA SUBIR
                                            NOTA :: DOCENTE</label>
                                        <input type="date"
                                            class="form-control @error('fecha_limite_notas') border-danger @enderror"
                                            wire:model="fecha_limite_notas" id="fecha_limite_notas" required
                                            pattern="\d{4}-\d{2}-\d{2}">
                                        @error('fecha_limite_notas')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        <span class="text-info">Establece límite de edición de notas hasta las
                                            23:59:59</span>
                                    </div>
                                </div>
                                ...
                                @if ($fecha_limite_notas !== '' && !is_null($fecha_limite_notas))
                                    <div class="col-md-12">
                                        <p><b>HASTA: </b>
                                            {{ \Carbon\Carbon::parse($fecha_limite_notas)->locale('es')->isoFormat('dddd\, D \d\e MMMM \d\e YYYY') }}
                                        </p>
                                    </div>
                                @endif
                            </div>
            ...
            <div wire:ignore.self data-bs-backdrop="static" id="editar_subir_nota_plan_asignatura_convocatoria"
                class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            @if (!is_null($convocatoria_actual_subir_nota))
                                <h5 class="modal-title mt-0" id="myModalLabel">
                                    {{ $convocatoria_actual_subir_nota->nombre_convocatoria }}</h5>
                            @endif
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="fecha_limite_notas_conv">FECHA LÍMITE PARA
                                            SUBIR NOTAS </label>
                                        <input type="date"
                                            class="form-control @error('fecha_limite_notas_conv') border-danger @enderror"
                                            wire:model="fecha_limite_notas_conv" id="fecha_limite_notas_conv" required
                                            pattern="\d{4}-\d{2}-\d{2}">
                                    ...
                                    @if ($fecha_limite_notas_conv !== '' && !is_null($fecha_limite_notas_conv))
                                        <div class="col-md-12">
                                            <p><b>HASTA: </b>
                                                {{ \Carbon\Carbon::parse($fecha_limite_notas_conv)->locale('es')->isoFormat('dddd\, D \d\e MMMM \d\e YYYY') }}
                                            </p>
                                        </div>
                                    @endif
                                </div>
            ...
            <div wire:ignore.self data-bs-backdrop="static" id="editar_libro_folio_plan_asignatura"
                class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('libro_notas_materia') border-danger @enderror"
                                            wire:model="libro_notas_materia" id="libro_notas_materia">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('nro_folio_materia') border-danger @enderror"
                                            id="nro_folio_materia" wire:model="nro_folio_materia" />
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-2">
                                        <input type="text"
                                            class="form-control @error('buscar_ci_docente') border-danger @enderror"
                                            wire:model="buscar_ci_docente" id="buscar_ci_docente" maxlength="14">
                                    ...
                                    <div class="col-md-4 mb-1">
                                        <button class="btn btn-success waves-effect waves-light"
                                            wire:click="buscar_por_ci_docente">BUSCAR</button>
                                        <button class="btn btn-danger waves-effect waves-light"
                                            wire:click="cancelar_ci_docente" title="cancelar busqueda"><i
                                                class="bx bx-window-close color-white"></i></button>
                                    </div>
                                        ...
                                        @if (!is_null($docente_buscar_upea))
                                            <div class="col-md-12 row g-3 bg-soft-success rounded-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <span><span
                                                            title="Paterno">{{ $docente_buscar_upea->paterno }}</span>
                                                        <span
                                                            title="Materno">{{ $docente_buscar_upea->materno }}</span>
                                                        <span class="text-secondary"
                                                            title="Nombres">{{ $docente_buscar_upea->nombre }}</span></span>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6 ">
                                                    <b>CI: </b> <br>
                                                    <span>{{ $docente_buscar_upea->ci }}
                                                        {{ $docente_buscar_upea->expedido }}</span>
                                                </div>
                                                <div class="col-md-6 mb-2">
                                                    <button class="btn btn-info waves-effect waves-light"
                                                        wire:click="asignar_docente({{ $docente_buscar_upea->id_persona }})">ASIGNAR</button>
                                                </div>
                                            </div>
                                        @else
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <label
                                            class="form-label @error('id_base_upea_docente') border-danger @enderror"
                                            for="id_base_upea_docente">Docente:</label>
                                        <input type="number" class="form-control  d-none" id="id_base_upea_docente"
                                            wire:model="id_base_upea_docente" />
                                        ...
                                        <div class="data-docente">
                                            ...
                                            @else
                                                <span title="Nombres">{{ $docente_tmp->paterno }}
                                                    {{ $docente_tmp->materno }} {{ $docente_tmp->nombre }}</span>
                                                <br>
                                                <span title="C.I.">{{ $docente_tmp->ci }}
                                                    {{ $docente_tmp->expedido }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    @if ($plan_asignatura_docente->siadi_convocatoria->modalidad->id_convocartoria_estudiante == 2)
                                        <div class="col-md-12 mb-4">
                                            <label class="form-label" for="nro_resolucion_hcc_examen">Resolución
                                                RHCC:</label>
                                            <input type="text"
                                                class="form-control @error('nro_resolucion_hcc_examen') border-danger @enderror"
                                                id="nro_resolucion_hcc_examen" wire:model="nro_resolucion_hcc_examen">
                                    ...
                                    @else
                                        <div class="col-md-6 mb-4">
                                            <label class="form-label"
                                                for="id_nombramiento_docente">Nombramiento:</label>
                                            <select
                                                class="form-select @error('id_nombramiento_docente') border-danger @enderror"
                                                id="id_nombramiento_docente" wire:model="id_nombramiento_docente">
                                                <option value="">Seleccione..</option>
                                                @if (!is_null($nombramientos))
                                                    @foreach ($nombramientos as $nom)
                                                        <option value="{{ $nom['codex'] }}">
                                                            {{ $nom['item_nombramiento'] }} .::
                                                            {{ $nom['tipo_categoria_rgs'] }} .:: {{ $nom['sede'] }}
                                                            .:: {{ $nom['fecha_emision_nombramiento'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
