                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                </script> © By Unidad Sie - Navi - <a href="https://www.gcod.dev/" target="_blank"
                                    style="color:var(--bs-footer-color)">Gary</a> - Freddy
                            </div>
                            <div class="col-sm-6">
...
// Livewire.on('holamundo', function(persona) {
//     var url = "{{ route('pre-inscripcion.index') }}";
//     window.location.href = url;
//    document.dispatchEvent(new Event('ejecutarHolaejecucion'));
// });

//        document.addEventListener('ejecutarHolaejecucion', function() {
