...
@section('body-page')
    <section class="page-title">
        <div class="icon_bg">
            <img src="{{ $intitucion->intitucion_url_banner1 }}" alt="banner">
        </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-st1">
                        <div class="overlay">
                            <img src="{{ asset('assets/risebothtml/assets/images//backgroup/bg-slider.png') }}"
                                alt="">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box-slider">
                                        <div class="content-box">
                                            <h1 class="title"
                                                style="color: blue; text-shadow: 0px 5px 4px white, 0px 0px 5px #c0c0c0;">
                                                {{ $intitucion->intitucion_titulo }}</h1>
                                            <p class="sub-title">{{ $intitucion->intitucion_subtitulo }}</p>
                                            <div class="wrap-btn">
                                        ...
                                        <div class="image">
                                            ...
                                            <div class="icon icon1">
                                                <img src="{{ asset('assets/otros/idioma2-rem.png') }}" alt="">
                                            </div>
                                            <div class="icon icon2">
                                                <img src="{{ asset('assets/otros/idioma3-rem.png') }}" alt="">
                                            </div>
                                            <div class="icon icon3">
                                                <img src="{{ asset('assets/otros/idioma4-rem.png') }}" alt="">
                                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title mb40" data-aos="fade-up" data-aos-duration="800">
                        <h2 class="title">
                            Nuestras Autoridadesxadasdsads
                        </h2>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="team-box-wrapper">
                        <div class="team-box" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
                            ...
                            <div class="image">
                                <img src="{{ $intitucion->intitucion_rector }}" alt="">
                            </div>
                            <div class="content">
                                <h5 class="name"><a href="team-details.html">{{ $intitucion->rector_nombre }}</a></h5>
                                <p class="position">RECTOR UNIVERSIDAD PUBLICA DE EL ALTO</p>
                                <ul class="social">
                                    <li>
                                        <a href="#">
                        ...
                        <div class="team-box" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
                            ...
                            <div class="image">
                                <img src="{{ $intitucion->intitucion_vicerector }}" alt="">
                            </div>
                            <div class="content">
                                <h5 class="name"><a href="team-details.html">{{ $intitucion->vicerector_nombre }}</a>
                                </h5>
                                <p class="position">VICERRECTOR UNIVERSIDAD PÚBLICA DE EL ALTO</p>
                                <ul class="social">
                                    <li>
                                        <a href="#">
                                            <svg width="13" height="22" viewBox="0 0 13 22" fill="none"
                        ...
                        <div class="team-box" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                            ...
                            <img class="shape_ecfect" src="./assets/images/common/shape_4.svg" alt="">
                            <div class="image">
                                <img src="{{ $intitucion->intitucion_jefe }}" alt="">
                            </div>
                            <div class="content">
                                <h5 class="name"><a href="team-details.html">{{ $intitucion->jefe_nombre }}</a></h5>
                                <p class="position"> Encargada departamento de idiomas</p>
                                <ul class="social">
                                    <li>
                                        <a href="#">
                                            <svg width="13" height="22" viewBox="0 0 13 22" fill="none"
    ...
    {{-- <section class="tf-section project_2">
        <div class="overlay">
            <img src="{{asset('assets/risebothtml/assets/images/backgroup/bg_project.png')}}" alt="asda">
        </div>
    ...
    {{-- <section class="tf-section project2">
            <div class="container w_1280">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="container_inner">
                            <div class="swiper-container slider-8" data-aos="fade-in" data-aos-duration="1000">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="project-box-style5">
                                            <span class="boder"></span>
                                            <div class="img-box">
                                                <div class="image">
                                                    <img class="mask" src="./assets/images/common/project_21.png" alt="">
                                                    <div class="shape">
                                                        <img src="./assets/images/common/shape.png" alt="">
                                                    </div>
                                                </div>
                                                <div class="content">
                                                        <h5 class="heading"><a href="project-grid.html">Garena Free Fire MAX</a></h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque</p>
                                                </div>
                                            </div>
                                            <div class="content-inner">
                                                <div class="total">
                                                    <h6>Total raise</h6>
                                                    <p class="price">332497.30 BUSD</p>
                                                </div>
                                                <ul>
                                                    <li>
                                                        <p class="text">Maximum</p>
                                                        <p class="price">2889.18 BUSD</p>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="content-progress-box style2">
                                                    <div class="progress-bar" data-percentage="100%">
                                                        <p class="progress-title-holder">
                                                            <span class="progress-title">
                                                                <span class="white">Progress</span>
                                                                <span>Max Participants <span class="white">4472</span></span>
                                                            </span>
                                                        ...
                                                        <span class="progress-number-wrapper">
                                                            <span class="progress-number-mark">
                                                                <span class="white percent"></span>
                                                            </span>
                                                            <span class="total">6649945.92/6650000 BVC</span>
                                                        </span>
                                                    </div> 
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="project-box-style5">
                                            ...
                                            <div class="img-box">
                                                ...
                                                <div class="content">
                                                        <h5 class="heading"><a href="project-grid.html">Oddmar</a></h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed pellentesque</p>
                                                </div>
                                            </div>
                                            <div class="content-inner">
                            ...
                            <div class="next_slider-8 next_slider"><svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.5 8H16.5M16.5 8L9.75 1.25M16.5 8L9.75 14.75" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                </div>
                            <div class="prev_slider-8 prev_slider"><svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.5 8H1.5M1.5 8L8.25 1.25M1.5 8L8.25 14.75" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                </div>
                        </div>
         ...
         <section class="tf-section three_step">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="tf-title mb46 left" data-aos="fade-up" data-aos-duration="800">
                        <h2 class="title">
                            Easy to join IGO <br class="show-destop">
                            with 3 steps
                        </h2>
                    </div>
                    <div class="wrap-box">
                        ...
                        <div class="icon-box-style3">
                            ...
                            <div class="content">
                                <h5 class="title">Verify Wallet</h5>
                        ...
                        <div class="icon-box-style3">
                            ...
                            <div class="content">
                                <h5 class="title">Start Staking</h5>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at nunc non ligula suscipit tincidunt at sit amet nunc.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="image pt30">
                        <img src="./assets/images/common/img_step.png" class="move5" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="flat-tabs" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="menu-tab">
                            <li class="active"><span>oncoming</span></li>
                            <li><span>Upcoming</span></li>
                            <li><span>ended</span></li>
                        </ul>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="project-box-style4">
                                                    <div class="image">
                                                        <div class="img_inner">
                                                            <img src="./assets/images/common/project_13.png"
                                                                alt="">
                                                            <img class="shape" src="./assets/images/common/shap.png"
                                                                alt="">
                                                        </div>
                                                        <div class="label">
                                                            1ST Phase
                                            ...
                                            <div class="swiper-slide">
                                                <div class="project-box-style4">
                                                    <div class="image">
                                                        <div class="img_inner">
                                                            <img src="./assets/images/common/project_14.png"
                                                                alt="">
                                                            <img class="shape" src="./assets/images/common/shap.png"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <div class="content">
                                                        <h5 class="heading"><a href="project-grid.html">Fruit Ninja</a>
                                                        </h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit.
                                                            Praesent varius risus sed pellentesque</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="project-box-style4">
                                                    <div class="image">
                                                        <div class="img_inner">
                                                            <img src="./assets/images/common/project_15.png"
                                                                alt="">
                                                            <img class="shape" src="./assets/images/common/shap.png"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <div class="content">
                                                        <h5 class="heading"><a href="project-grid.html">Shadowgun
                                                                Legends</a></h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit.
                                                            Praesent varius risus sed pellentesque</p>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="project-box-style4">
                                                    <div class="image">
                                                        <div class="img_inner">
                                                            <img src="./assets/images/common/project_16.png"
                                                                alt="">
                                                            <img class="shape" src="./assets/images/common/shap.png"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <div class="content">
                                                        <h5 class="heading"><a href="project-grid.html">Dead Trigger 2</a>
                                                        </h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit.
                                                            Praesent varius risus sed pellentesque</p>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="project-box-style4">
                                                    ...
                                                    <div class="content">
                                                        <h5 class="heading">Dead Trigger 2</h5>
                                                        <p class="desc">Lorem ipsum dolor sit amet, consectetur
                                                            adipiscing elit.
                                                            Praesent varius risus sed pellentesque</p>
                                                        <ul>
                    ...
                    <div class="project-wrapper">
                        <div class="image-wrapper" data-aos="fade-in" data-aos-duration="1000">
                            <div class="swiper-container slider-1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/risebothtml/assets/images/slider/img_slider_1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ asset('assets/risebothtml/assets/images/slider/img_slider_1.jpg') }}"
                        ...
                        <div class="content-wrapper">
                            <div class="content_inner" data-aos="fade-left" data-aos-duration="1200">
                                <div class="wrapper">
                                    <h4>Codyfight IGO</h4>
                                    <p class="desc">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent varius risus sed
                                        pellentesque
                                    </p>
                                    <ul class="price">
                                        <li>
