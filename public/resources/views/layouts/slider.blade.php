<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        @endcanany
        @canany(['planificar_convocatoria.index', 'planificar_asignatura.index', 'planificar_asignatura.index',
            'planificar_paralelo.index'])
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    @endcan
                    @can('planificar_asignatura.index')
        ...
        @endcanany
        @canany(['pre-inscripcion.index', 'persona.index', 'inscripcion.index'])
        ...
        @endcanany
        @canany(['buscar_certificado.index'])
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    @endcan
                    @can('buscar_certificado.index')
                        <li><a href="{{ route('certificado-lotes.index') }}">VERIFICAR CERTIFICADO</a></li>
                    @endcan
                </ul>
            </li>
