    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">LISTA DE ASIGNACIÓNNNNNNNNNNNNNNNNN</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home.index') }}">Inicio</a></li>
                        <li class="breadcrumb-item active">LISTA DE ASIGNACIÓN</li>
                    </ol>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button"
                                                    ...
                                                    style="border-radius: 50%" title="Editar"
