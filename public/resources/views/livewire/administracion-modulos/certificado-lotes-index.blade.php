                ...
                @if($this->asignatura=="" && $this->statusAsignatura)
                    ...
                    <ul>
                        ...
                        @foreach($asignaturas_all as $asign)
                            <li>id_asig: {{$asign->id_siadi_asignatura}}, id_plan_asign: {{$asign->id_planificar_asignatura}} || {{$asign->materia}} {{$asign->paralelo}}|| IDCNOTA: {{$asign->ids_inscripcion_con_nota}} ; IDCCERT {{$asign->ids_certificados_con_certificado}}</li>
                        @endforeach
                    </ul>
