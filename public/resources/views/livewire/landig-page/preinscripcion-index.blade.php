<div>
    ...
    <div class="modal fade " id="login_persona_existente" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">INGRESAR AL SISTEMA</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl " role="document">
            <div class="modal-content">
                ...
                <div class="header-popup">
                    ...
                    <div class="desc">
                        Complete los campos para su registro, una vez llenado debera realizar su preinscripcion
                    </div>
                     ...
                     <div class="row">
                        ...
                        @if ($tipopago == 'Depósito')
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Ingrese el monto de deposito"
                                    wire:model="monto">
                            </div>
                            @error('monto')
                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="username">{{ __('Ingresar Correo Electronico Ej. idioma@upea.bo') }}</label>
                                                <x-input id="email" class="form-control" type="email"
                                                    name="email" :value="old('email')" required autofocus
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="userpassword">{{ __('Ingrear su contraseña Ej. 1994-12-21') }}</label>
                                                <x-input id="password" class="form-control" type="password"
                                                    name="password" required autocomplete="current-password"
